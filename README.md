...
the virtual machine and the 'champion' were created by [@supalarry](https://github.com/supalarry) and me.
    
the assembler, disassembler were created by [@k-off](https://github.com/k-off/)
